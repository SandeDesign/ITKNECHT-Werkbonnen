      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
        ...
        >
          <div className="p-6">
            ...
            <div className="mb-6">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Taak:</p>
              ...
              {showNotesField && (
                ...
                >
                  ...
                  <textarea
                    ...
                    rows={4}
                    disabled={isLoading}
                    className="w-full px-3 py-2 text-sm text-gray-900 dark:text-white bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 resize-none disabled:opacity-50"
                  />
                </motion.div>
              )}
            </AnimatePresence>
